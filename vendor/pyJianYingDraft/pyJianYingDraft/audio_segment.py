...
SOURCE_TIMERANGE_TOLERANCE_US = 250000
...
class AudioSegment(MediaSegment):
    ...
    def __init__(self, material: Union[AudioMaterial, str], target_timerange: Timerange, *,
        ...
        if source_timerange.end > material.duration:
            overflow = source_timerange.end - material.duration
            # 与上游解析/校验保持一致，容忍极小的时长误差并裁到素材结尾。
            if overflow <= SOURCE_TIMERANGE_TOLERANCE_US and source_timerange.start <= material.duration:
